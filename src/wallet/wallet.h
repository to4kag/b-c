...
public:
    ...
    ScanResult ScanForWalletTransactions(const CBlockIndex& index_start, const CBlockIndex* const pindexStop, const WalletRescanReserver& reserver, const CBlockIndex*& failed_block, const CBlockIndex*& stop_block, bool fUpdate = false);
