...
BOOST_AUTO_TEST_CASE(streams_vector_writer)
{
    ...
    CVectorWriter(Ser::NETWORK, INIT_PROTO_VERSION, vch, 0, a, b);
    BOOST_CHECK((vch == std::vector<unsigned char>{{1, 2}}));
    CVectorWriter(Ser::NETWORK, INIT_PROTO_VERSION, vch, 0, a, b);
    BOOST_CHECK((vch == std::vector<unsigned char>{{1, 2}}));
    vch.clear();

    CVectorWriter(Ser::NETWORK, INIT_PROTO_VERSION, vch, 2, a, b);
    ...
    vch.resize(4, 0);
    CVectorWriter(Ser::NETWORK, INIT_PROTO_VERSION, vch, 3, a, b);
    ...
    vch.resize(4, 0);
    CVectorWriter(Ser::NETWORK, INIT_PROTO_VERSION, vch, 4, a, b);
    BOOST_CHECK((vch == std::vector<unsigned char>{{0, 0, 0, 0, 1, 2}}));
    CVectorWriter(Ser::NETWORK, INIT_PROTO_VERSION, vch, 4, a, b);
    BOOST_CHECK((vch == std::vector<unsigned char>{{0, 0, 0, 0, 1, 2}}));
    vch.clear();

    CVectorWriter(Ser::NETWORK, INIT_PROTO_VERSION, vch, 0, bytes);
    ...
    vch.resize(4, 8);
    CVectorWriter(Ser::NETWORK, INIT_PROTO_VERSION, vch, 2, a, bytes, b);
...
BOOST_AUTO_TEST_CASE(streams_vector_reader)
{
    ...
    VectorReader reader(Ser::NETWORK, INIT_PROTO_VERSION, vch, 0);
...
{
    CDataStream data(Ser::NETWORK, INIT_PROTO_VERSION);
...
BOOST_AUTO_TEST_CASE(streams_serializedata_xor)
{
    ...
    CDataStream ds(in, Ser::NETWORK, 0);
