...
//! -maxtxfee default
constexpr CAmount DEFAULT_TRANSACTION_MAXFEE = 0.1 * COIN;
//! Discourage users to set fees higher than this amount (in satoshis) per kB
constexpr CAmount HIGH_TX_FEE_PER_KB = 0.01 * COIN;
//! -maxtxfee will warn if called with a higher fee than this amount (in satoshis)
constexpr CAmount HIGH_MAX_TX_FEE = 100 * HIGH_TX_FEE_PER_KB;
/** Default for -limitancestorcount, max number of in-mempool ancestors */
constexpr unsigned int DEFAULT_ANCESTOR_LIMIT = 25;
/** Default for -limitancestorsize, maximum kilobytes of tx + all in-mempool ancestors */
constexpr unsigned int DEFAULT_ANCESTOR_SIZE_LIMIT = 101;
/** Default for -limitdescendantcount, max number of in-mempool descendants */
constexpr unsigned int DEFAULT_DESCENDANT_LIMIT = 25;
/** Default for -limitdescendantsize, maximum kilobytes of in-mempool descendants */
constexpr unsigned int DEFAULT_DESCENDANT_SIZE_LIMIT = 101;
/** Default for -mempoolexpiry, expiration time for mempool transactions in hours */
constexpr unsigned int DEFAULT_MEMPOOL_EXPIRY = 336;
/** Maximum kilobytes for transactions to store for processing during reorg */
constexpr unsigned int MAX_DISCONNECTED_TX_POOL_SIZE = 20000;
...
constexpr int MAX_CMPCTBLOCK_DEPTH = 5;
/** Maximum depth of blocks we're willing to respond to GETBLOCKTXN requests for. */
constexpr int MAX_BLOCKTXN_DEPTH = 10;
...
constexpr unsigned int AVG_ADDRESS_BROADCAST_INTERVAL = 30;
/** Average delay between trickled inventory transmissions in seconds.
 *  Blocks and whitelisted receivers bypass this, outbound peers get half this delay. */
constexpr unsigned int INVENTORY_BROADCAST_INTERVAL = 5;
...
constexpr int64_t BLOCK_DOWNLOAD_TIMEOUT_BASE = 1000000;
/** Additional block download timeout per parallel downloading peer (i.e. 5 min) */
constexpr int64_t BLOCK_DOWNLOAD_TIMEOUT_PER_PEER = 500000;

constexpr int64_t DEFAULT_MAX_TIP_AGE = 24 * 60 * 60;
/** Maximum age of our tip in seconds for us to be considered current for fee estimation */
constexpr int64_t MAX_FEE_ESTIMATION_TIP_AGE = 3 * 60 * 60;
...
constexpr unsigned int DEFAULT_BANSCORE_THRESHOLD = 100;
/** Default for -persistmempool */
constexpr bool DEFAULT_PERSIST_MEMPOOL = true;
/** Default for -mempoolreplacement */
constexpr bool DEFAULT_ENABLE_REPLACEMENT = true;
/** Default for using fee filter */
constexpr bool DEFAULT_FEEFILTER = true;

/** Maximum number of headers to announce when relaying blocks with headers message.*/
constexpr unsigned int MAX_BLOCKS_TO_ANNOUNCE = 8;

/** Maximum number of unconnecting headers announcements before DoS score */
constexpr int MAX_UNCONNECTING_HEADERS = 10;
...
constexpr unsigned int MIN_BLOCKS_TO_KEEP = 288;
/** Minimum blocks required to signal NODE_NETWORK_LIMITED */
constexpr unsigned int NODE_NETWORK_LIMITED_MIN_BLOCKS = 288;

static const signed int DEFAULT_CHECKBLOCKS = 6;
constexpr unsigned int DEFAULT_CHECKLEVEL = 3;
 ...
 */
constexpr unsigned int REJECT_INTERNAL = 0x100;
/** Too high fee. Can not be triggered by P2P transactions */
constexpr unsigned int REJECT_HIGHFEE = 0x100;
